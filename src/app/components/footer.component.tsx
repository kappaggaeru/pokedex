        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center text-sm text-gray-500 pb-8">
                    ...
                    <p className="p-4">All shown data belongs to <a href="https://pokeapi.co/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-300 transition-colors duration-200">PokeAPI</a></p>
                </div>
            </div>
        </div>
    );
